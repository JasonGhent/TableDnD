...
jQuery.tableDnD = {
  ...
  build: function(options) {
    ...
    jQuery(document)
      .bind('mousemove touchmove', jQuery.tableDnD.mousemove)
      .bind('mouseup touchend', jQuery.tableDnD.mouseup);
  ...
  makeDraggable: function(table) {
   ...
   // inspired by John Tarr and Famic
      ...
      if (! nodrag) { //There is no NoDnD attribute on rows I want to drag
        jQuery(rows[i]).on('mousedown touchstart',function(ev) {
  ...
  mouseCoords: function(ev){
    if(ev.pageX || ev.pageY || ev.originalEvent.touches[0].pageX || ev.originalEvent.touches[0].pageY){
      return {x:ev.pageX || ev.originalEvent.touches[0].pageX, y:ev.pageY || ev.originalEvent.touches[0].pageY};
    }
    return {
